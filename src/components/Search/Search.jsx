...
const Search = () => {
  ...
  return (
    <Flex my='3' direction='column' borderRadius='md' bg='#fff' boxShadow='md' p='5' id='search' marginTop='4'>
      ...
      <Flex gap={{base: 3, md: 2}} direction={{base: 'column', md:'row'}} borderRadius='30'>
        ...
        <PropertyTypeFilter />
        <PriceFilter />
        <Button id='searchbtn' onClick={searchHandler} p={{base: 3, md: 2}} size="100%">Search</Button>
      </Flex>
    </Flex>
  )
}
